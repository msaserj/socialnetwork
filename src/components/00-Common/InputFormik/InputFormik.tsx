    ...
    return (
        <div className={css.form}>
            ...
            <div className={css.inputBlock}>
                <input className={css.input} placeholder={placeholder} id={htmlFor}
                       type={type} {...getFieldProps} {...restProps}/>
    ...
    return (
        <div>
            <div className={css.checkboxBlock}>
                <input className={css.checkbox} placeholder={props.placeholder}
                       type={"checkbox"} {...props.getFieldProps}/>
    ...
    return (<>
            ...
            <select className={css.select} id={htmlFor} {...getFieldProps} {...restProps}>
                {selectOptions && selectOptions.map((e, i) => {
                    return <option key={i} className={css.option} value={e.value}>{e.title}</option>
                })}
            </select>
        </>
