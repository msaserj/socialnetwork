...
import { Music } from '../SideWidgets/Music/Music';
import { Video } from '../SideWidgets/Video/Video';

const DialogsContainer = React.lazy(() =>
  import('../SideWidgets/Dialogs/DialogsContainer').then(({ DialogsContainer }) => ({ default: DialogsContainer }))
);
const MyPostsContainer = React.lazy(() =>
  import('../SideWidgets/MyPosts/MyPostsContainer').then(({ MyPostsContainer }) => ({ default: MyPostsContainer }))
);
